package com.project.bidit.security;
...
import com.project.bidit.token_utils.JwtToUserConverter;
import com.project.bidit.token_utils.KeyUtils;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(authorize -> authorize.antMatchers("/api/auth/*").permitAll()
